...
function(get_cmakejs_output CMAKEJS_CMD)
    ...
    message(STATUS "CMAKE_JS_OUTPUT: ${CMAKE_JS_OUTPUT}")
...
function(parse_cmakejs_output CMAKE_JS_OUTPUT)
    ...
    if(CMAKE_JS_INCLUDE_MATCH AND CMAKE_JS_LIB_MATCH AND CMAKE_RUNTIME_OUTPUT_DIRECTORY_MATCH)
        ...
        string(REPLACE "-DCMAKE_RUNTIME_OUTPUT_DIRECTORY=" "" CMAKE_RUNTIME_OUTPUT_DIRECTORY "${CMAKE_RUNTIME_OUTPUT_DIRECTORY_MATCH}")
        ...
        message(FATAL_ERROR "[CMakeJS] Failed to parse CMake.js output")
    endif()
endfunction()
